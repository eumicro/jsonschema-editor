...
import { getStartedFor } from "../i18n/get-started-i18n.js";
...
export function GetStartedPage({ locale, onOpenExamples }: GetStartedPageProps) {
  const content = getStartedFor(locale);
