...
export class AttributeControlRegistry<TNode = unknown> {
  ...
  setDefault(component: ComponentType<unknown>): this {
  ...
  resolve(context: AttributeControlContext<TNode>): ComponentType<any> | null {
  ...
  private matches(
    matcher: AttributeMatcher<TNode>,
    context: AttributeControlContext<TNode>,
  ): boolean {
