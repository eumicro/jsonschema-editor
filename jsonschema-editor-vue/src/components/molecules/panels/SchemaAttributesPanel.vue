  ...
  <div class="jse-attributes-panel">
    ...
    >
      <JseCheckbox
        ...
        :disabled="readonly"
        @update:model-value="setRequired($event)"
      />
    </JseFormField>

    <JseFormField v-if="showItemsTypeControl && !readonly" :label="t('schemaAttributes.itemsType')">
      <ArrayItemsTypeControl compact :current-kind="itemsTypeKind" @select="setItemsType" />
    </JseFormField>

    <SchemaFieldBulkActions
      v-if="showBulkFieldActions && !readonly"
